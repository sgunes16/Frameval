...
help:
	...
	@echo ""
	@echo "  test                      Run all unit tests across services"
	@echo "  test-engine               Go unit tests with -race"
	@echo "  test-engine-integration   Go integration tests (build tag: integration)"
	@echo "  test-grader               Python grader tests"
