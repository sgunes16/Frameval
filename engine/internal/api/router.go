...
func NewRouter(service *Service) http.Handler {
	...
	r.Route("/api", func(r chi.Router) {
		...
		r.Post("/variants/{id}/catalog-extensions", service.ImportCatalogExtensions)
		...
		r.Get("/baselines", service.ListBaselines)
		r.Get("/baselines/{id}", service.GetBaseline)
		r.Get("/config/models", service.ListModels)
		r.Get("/config/agents", service.ListAgents)
		r.Get("/config/catalog/extensions", service.ListCatalogExtensions)
